//! Phase 3 (R4) engine tests: structural anchoring survives a reformat and a
//! move that defeat the text rungs, stays `anchored` under an
//! indentation-only change, and still orphans honestly when the construct is
//! deleted — and, crucially, does *not* false-anchor onto a surviving
//! enclosing construct when the noted region inside it was deleted or
//! rewritten.
