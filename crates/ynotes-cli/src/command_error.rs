...
/// [`ynotes::Error::InvalidIdPrefix`], [`ynotes::Error::SymlinkEscape`],
/// [`ynotes::Error::CodeNotFound`], and [`ynotes::Error::CodeAmbiguous`],
...
impl From<ynotes::Error> for CommandError {
    fn from(e: ynotes::Error) -> Self {
        match e {
            ...
            | ynotes::Error::SymlinkEscape { .. }
            | ynotes::Error::CodeNotFound
            | ynotes::Error::CodeAmbiguous { .. }
            | ynotes::Error::Unconfirmable { .. }
            | ynotes::Error::Unidentified { .. } => CommandError::Usage(e.to_string()),
