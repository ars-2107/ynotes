//! The CLI entry point: argument parsing, logging, dispatch, and exit codes.
//!
//! Clap rejects invalid arguments before dispatch. [`exit_on_parse_error`]
//! renders those failures as JSON when requested, preserving the output contract.
